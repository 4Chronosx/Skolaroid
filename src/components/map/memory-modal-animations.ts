...
// Starts flat (0°), opens by rotating -180° around right edge
...
// Starts flat (0°), opens by rotating +180° around left edge
...
// When going NEXT: right page rotates from 0° to -180° (turns over to the left)
...
// When going PREV: left page rotates from 0° to 180° (turns over to the right)
